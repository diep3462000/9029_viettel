...
public abstract class Msg
    ...
    public String debugString() {
        ...
        s = new StringBuilder().append(s).append(", campaignId=").append(this.campaignId).toString();
        s = new StringBuilder().append(s).append(", campaignCode=").append(this.campaignCode).toString();
    ...
    public static String msgToString(Msg msg) {
        ...
        s = new StringBuilder().append(s).append(",").append(msg.campaignId).toString();
        s = new StringBuilder().append(s).append(",").append(msg.campaignCode).toString();
