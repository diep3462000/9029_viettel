 ...
 */
@WebService(serviceName = "GetContentActionService")
@Stateless()
public class GetContentActionService {
    ...
    private static final String logDir = "/data/smsgw2vtl/ws-log/op-sdp-mps-ws-getcontent-server/";
    ...
    public GetContentActionService(){
    ...
    private void sendJMSObject(MOMsg moMsg) throws IOException{
        ...
        try{
            ...
            try {
                ...
                Logger.getLogger(GetContentActionService.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
        finally{
            if (jmsMessageProducer != null) {
