 ...
 */
@WebService(serviceName = "MoReceiver9029")
@Stateless()
public class MoReceiver9029 {

    public static final Logger logger = Logger.getLogger(MoReceiver9029.class.getName());
    ...
    protected Destination getJmsDestination(String rqServiceId, Session jmsSession){
        ...
        try{
            ...
            try {
                ...
                Logger.getLogger(MoReceiver9029.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    ...
    private void loggerInitilazation(){
        try {
            ...
            Logger.getLogger(MoReceiver9029.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if (dataProcessor.validateParamsGetContent(username, password, serviceid, msisdn, params, mode, amount, command)) {
                if (dataProcessor.antheticateWS(username, password,properties.getProperty("username"),properties.getProperty("password"))) {
                    ...
                    if(mode.equalsIgnoreCase("REAL")){
                        ...
                        if(obj9029Result.moLogMsg!=null){
                            this.sendJMSObjectLog(obj9029Result.moLogMsg,"molog");
                        }
                        if(obj9029Result.mtLogMsg!=null){
                            this.sendJMSObjectLog(obj9029Result.mtLogMsg,"mtlog");
                        }
...
//        
    ...
    private void sendJMSObject(MOMsg moMsg) throws IOException{
        ...
        try{
            ...
            logString = String.format("sendJMSObject(): Exception: {0}\n", new Object[]{ex.getMessage()});
            try {
                logBufferWriter.write(logString);
            } catch (IOException ex1) {
    ...
    private void sendJMSObjectLog(com.centech.smsgw.common.Msg moMsg,String destinationId) throws IOException{
        Connection jmsConnection = null;
        Session jmsSession = null;
        MessageProducer jmsMessageProducer = null;
        String logString = "";
        ...
        try{
            if (this.jmsConnectionFactory != null) {
                ...
                if (jmsSession != null) {
                    ...
                    jmsMessageProducer = jmsSession.createProducer(this.getJmsDestination(destinationId, jmsSession));
